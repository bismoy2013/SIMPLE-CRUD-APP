...
public class NewMasterDetailForm extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<democrudapp.Customer> toRemove = new ArrayList<democrudapp.Customer>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            democrudapp.Customer c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        democrudapp.Customer c = new democrudapp.Customer();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<democrudapp.Customer> merged = new ArrayList<democrudapp.Customer>(list.size());
            for (democrudapp.Customer c : list) {
    ...
    private java.util.List<democrudapp.Customer> list;
